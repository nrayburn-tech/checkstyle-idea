...
public final class PluginConfigurationBuilder {
    ...
    public PluginConfigurationBuilder withBaseDownloadUrl(@Nullable final String newBaseDownloadUrl) {
      this.baseDownloadUrl = newBaseDownloadUrl;
      return this;
    }

    public PluginConfigurationBuilder withCachePath(@Nullable final Path newCachePath) {
